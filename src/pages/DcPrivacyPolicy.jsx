        ...
        <div className="row">
            <div className="col-md-12">
                ...
                <ul>
                    ...
                    <li> Application refers to DICOM Camera, the software program provided by the Company. </li>
                    <li> Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Raster Images Private Limited, 2nd Floor, #50/1, Brindavan Road, Alagapuram, Salem - 636004. Tamil Nadu, India. </li>
                    ...
                    <li> You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. <br /><br /> </li>
                </ul>

                <h4> Collecting and Using Your Personal Data </h4>
                <h5 className="mt-10"> Types of Data Collected </h5>
                <h6  className="mt-10"> Personal Data </h6>
                <p> While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to: </p>
                <ul>
                    <li> Usage Data </li>
                </ul>
                <h6 className="mt-25"> Usage Data </h6>
                ...
                <h5 className="mt-20"> Use of Your Personal Data </h5>
                <p> 
                ...
                <ul>
                    <li> With Service Providers: We may share Your personal information with Service Providers to monitor and analyse the use of our Service, to contact You. </li>
                ...
                <h5 className="mt-20"> Retention of Your Personal Data </h5>
                <p>
                ...
                <h6 className="mt-10"> Business Transactions </h6>
                <p>
                ...
                <p> Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency). <br /><br /> </p>
                ...
                <h6 className="mt-20"> Security of Your Personal Data </h6>
                <p> The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security. <br /><br /> </p>
                ...
                <ul>
                    <li> By visiting this page on our website: <Link to="/https://www.raster.in/contact-us"> https://www.raster.in/contact-us.php </Link> </li>
                </ul>
...
export default DcPrivacyPolicy;
